...
export interface ColdStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "distribute"
      | "distributed"
...
export interface ColdStorage extends BaseContract {
  connect(runner?: ContractRunner | null): ColdStorage;
  waitForDeployment(): Promise<this>;

  interface: ColdStorageInterface;
