...
export interface IPurchaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "at"
      | "balanceOf"
...
export interface IPurchase extends BaseContract {
  connect(runner?: ContractRunner | null): IPurchase;
  waitForDeployment(): Promise<this>;

  interface: IPurchaseInterface;
