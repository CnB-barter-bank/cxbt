...
export interface TransferableAccessManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "PUBLIC_ROLE"
...
export interface TransferableAccessManager extends BaseContract {
  connect(runner?: ContractRunner | null): TransferableAccessManager;
  waitForDeployment(): Promise<this>;

  interface: TransferableAccessManagerInterface;
