...
import type {
  ...
  TransferableAccessManagerInterface,
} from "../../../../../@bgrusnak/solidity-icoset/contracts/management/TransferableAccessManager";
...
export class TransferableAccessManager__factory {
  static readonly abi = _abi;
  static createInterface(): TransferableAccessManagerInterface {
    return new Interface(_abi) as TransferableAccessManagerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as TransferableAccessManager;
  }
}
