...
export interface CXBTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface CXBToken extends BaseContract {
  connect(runner?: ContractRunner | null): CXBToken;
  waitForDeployment(): Promise<this>;

  interface: CXBTokenInterface;
