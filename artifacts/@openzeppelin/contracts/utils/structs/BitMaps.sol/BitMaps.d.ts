...
export interface BitMaps$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "BitMaps",
  "sourceName": "@openzeppelin/contracts/utils/structs/BitMaps.sol",
  "abi": [],
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<BitMaps$Type["abi"]>>;
  export function deployContract(
    contractName: "@openzeppelin/contracts/utils/structs/BitMaps.sol:BitMaps",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<BitMaps$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<BitMaps$Type["abi"]>;
