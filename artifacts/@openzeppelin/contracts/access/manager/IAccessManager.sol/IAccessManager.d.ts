...
export interface IAccessManager$Type {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IAccessManager$Type["abi"]>>;
  export function deployContract(
    contractName: "@openzeppelin/contracts/access/manager/IAccessManager.sol:IAccessManager",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IAccessManager$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IAccessManager$Type["abi"]>;
